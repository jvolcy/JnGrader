...
def main():
    ...
    HOME_DIRS = '/home'
    D0103_01_expectedOutputs = ['Q1_Ans = 3', 'Q2_Ans = 6', 'Q3_Ans = 2', 'Q4_Ans = 7', 'Q5_Ans = 6', 'Q6_Ans = 7', 'Q7_Ans = 3', 'Q8_Ans = 8', 'Q9_Ans = 1', 'Q10_Ans = 4']

    expectedOutput = D0103_01_expectedOutputs

    studentNamesAndDirs = getStudentNamesAndDirs(HOME_DIRS)

    NOTEBOOK_PATH = 'Current-Course-Materials/assignments/D0103.01-data_types_and_structures_1/D0103.01-data_types_and_structures_1.ipynb'
    for nameAndDir in studentNamesAndDirs:
        ...
        for item in sourceAndOutput:
            ...
            #for this exercise, we are comparing the sources, not the outputs
            if item[0].split('=')[1] == expectedOutput[i].split('=')[1]:
                grade += 1
            i += 1
            print()
        '''
